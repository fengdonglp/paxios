...
var AsyncQueue = /*#__PURE__*/function () {
  ...
  _createClass(AsyncQueue, [{
    ...
    value: function _delete(fn) {
      this.chain = dropElements(this.chain, function (item) {
        return item === fn;
      });
    }
    /**
...
var requestFilter = new AsyncQueue();
...
var RequestPool = /*#__PURE__*/function () {
  ...
  _createClass(RequestPool, [{
    ...
    value: function clear() {
      this.pool.forEach(function (request) {
        request.cancel();
      });
      this.pool.clear();
    }
...
function Request(opts) {
  ...
  var ajaxRequest = service(lodash_merge(opts, {
    cancelToken: token
  })).then(function (res) {
...
methods.forEach(function (method) {
  Request[method] = function () {
    ...
    var opts = (hasData ? arguments.length <= 2 ? undefined : arguments[2] : arguments.length <= 1 ? undefined : arguments[1]) || {};
    return Request(lodash_merge(opts, {
...
//# sourceMappingURL=paxios.esm.js.map
